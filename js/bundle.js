...
/* harmony import */ var _tool__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_tool__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _readMore__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_readMore__WEBPACK_IMPORTED_MODULE_3__);
...
var hideBtn = document.getElementById('hide-more-btn');
var hiddenSlides = document.querySelectorAll('.brand-slide.hidden');
var showMoreRepair = document.getElementById('repair__show-more');
var hide = document.getElementById('repair__show-hide');
var hiddenSlide = document.querySelectorAll('.slide-brand.hidden');
...
var readmoreBtn = document.querySelectorAll('.read-more');
...
readmoreBtn.forEach(function (elem) {
  return elem.addEventListener('click', function () {
    if (window.innerWidth < 768) {
      document.querySelectorAll('.text__add').forEach(function (elem) {
        return elem.classList.toggle('text--unactive');
      });
    }

    if (window.innerWidth >= 768 && window.innerWidth < 1440) {
      document.querySelectorAll('.text__dop').forEach(function (elem) {
        return elem.classList.toggle('text__dop--unactive');
      });
    }
...
function qe() {
  ...
  if (window.innerWidth >= 768) {
    ...
    if (!swiper) {
      swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container', {
        slidesPerView: 'auto',
        pagination: {
...
var buttonBurger = document.querySelector('.button__burger');
var burgerMenu = document.querySelector('.burger-menu');
var buttonClose = document.querySelector('.button__close');
var page = document.querySelector('.page');
var background = document.querySelector('.background');
var buttonRepair = document.querySelectorAll('.button__repair');
var feedback = document.querySelector('.feedback-page');
var feedbackClose = document.querySelector('.feedback-btn');
...
var buttonCall = document.querySelectorAll('.button__call');
var call = document.querySelector('.call-page');
var callClose = document.querySelector('.call-btn');
